                            ...
                            <form class="form-horizontal" action="{{url('managerUsers/store')}}" method="post" >
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="remember_token" value="{{$info->remember_token}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="created_at" value="{{$info->created_at}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="updated_at" value="{{$info->updated_at}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="last_login_ip" value="{{$info->last_login_ip}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="role_id" value="{{$info->role_id}}">
                                        </div>
                                    </div>
                                </div>
