...
function openwin(url){window.open(url,"","top=200,left=200,width=910,height=500");};$("#chonz").bind('click',function(){openwin("view/chongzhijilu.html")});$("#tixi").bind('click',function(){openwin("view/tixianjilu.html")});$("#yongh").bind('click',function(){openwin("view/yonghulixi.html")});$("#lishi").bind('click',function(){openwin("view/lishixiadan.html")});$("#xingm").bind('click',function(){openwin("view/xiangmu.html")});$("#leiji").bind('click',function(){openwin("view/leiji.html")});$("#genz").bind('click',function(){openwin("view/genz.html")});$("#friend").bind('click',function(){openwin("view/friend.html")});
